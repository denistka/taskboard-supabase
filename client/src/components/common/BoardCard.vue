...
<template>
  <ui-card variant="strong" padding="md" :hover="true" class="shadow-lg flex flex-col h-full">
    <!-- Header: Title and Description -->
    <div class="flex-1 mb-6">
      <h3 class="text-2xl font-bold text-gray-100 mb-2">{{ board.name }}</h3>
      <p class="text-sm text-gray-400">{{ board.description || 'No description' }}</p>
    </div>
